    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
         ...
         <a href ="{{ url('tambah_layanan_pelanggan_free/'.$nopelanggan) }}" type="button" class="btn btn-primary btn-sm"><i class="fas fa-plus-square"></i>&nbsp;Layanan</a>
       </div>
       <!-- /.card-header -->
       <div class="card-body">
        <table id="example1" class="table table-bordered table-hover">
          <thead>
            <tr>
              ...
              <th><center>Status layanan pelanggan</center></th> <!-- aktif/nonaktif -->
              <th><center>Status penagihan layanan</center></th> <!-- Free/Berbayar -->
              <th><center>Tanggal aktivasi layanan</center></th>
              <th><center>Tanggal nonaktif layanan</center></th>
              <th><center>Perangkat/Barang</center></th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $datas->tanggal_aktivasi_layanan }}</td>
              <td>
              ...
              <td>
                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#edit{{ $datas->user_id }}">
                  <i class="fas fa-edit"></i>
                </button>
                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete{{ $datas->user_id }}">
              ...
              <div class="modal-dialog modal-xl">
                <div class="modal-content">
                  <div class="modal-header bg-warning">
                    <h4 class="modal-title">Edit Data Layanan Pelanggan {{ $datas->datapelanggan[0]->nama_pelanggan }}</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <form action="{{ url('data_layanan_pelanggan/edit/'.$datas->user_id.'/'.$datas->id_pelanggan) }}" method="post" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                      <div class="row col-lg-12">
                          <div class="col-lg-6">
                            ...
                            <div class="form-group">
                              ...
                              <select name="status_layanan_pelanggan" class="form-control select2" >
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="status_penagihan_layanan" value="Free" class="form-control"
                              disabled="">
                              <input type="hidden" name="status_penagihan" value="Free" class="form-control">
                            </div>
                            <div class="form-group">
                             ...
                             <div class="input-group">
                               ...
                               <input type="text" class="form-control tanggal" value="{{ date('d-m-Y',strtotime($datas->tanggal_aktivasi_layanan)) }}" name="tanggal_aktivasi_layanan">
                             </div>
                           </div>
                             <div class="form-group">
                        ...
                        <div class="col-lg-6">
                             <div class="form-group">
                              ...
                              <option value="{{ $data->id_pop }}" selected="true">{{ $data->nama_pop }}</option>
                              @else
                           ...
                           <div class="form-group">
                            <label>Notes :</label>
                            <input type="text" class="form-control" name="notes" value="{{ $datas->notes }}">
                          </div>
                          <div class="form-group">
                            <label>Datek IP Address :</label>
                            <input type="text" class="form-control" value="{{ $datas->datek_ip_address }}" name="datek_ip_address" >
                          </div>
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control tanggal" value="{{ date('d-m-Y',strtotime($datas->tanggal_nonaktif_layanan)) }}" name="tanggal_nonaktif_layanan">
                          </div>
                       </div>
                      </div>         
                    </div>
                ...
                <div class="modal-header">
                  ...
                  <div class="modal-body">
                    <p> Apakah anda yakin ingin menghapus <b> 
                      {{ $datas->layanan[0]->nama_layanan }}</b> milik {{ $datas->datapelanggan[0]->nama_pelanggan }}? </p>
                    </div>
                    <div class="modal-footer justify-content-between">
                      <button type="button" class="btn btn-outline-light" data-dismiss="modal">Batal</button>
                      <a href="{{ url('data_layanan_pelanggan/delete/'.$datas->user_id.'/'.$datas->id_pelanggan)  }}" type="button" class="btn btn-outline-light">Hapus</a>
                    </div>
                  </div>
                </div>
              </div>
