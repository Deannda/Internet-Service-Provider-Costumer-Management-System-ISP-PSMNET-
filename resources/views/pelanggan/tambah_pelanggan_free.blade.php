...
<section class="content-header bg-primary">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Tambah Data Pelanggan Free</h1>
      </div>
      <div class="col-sm-6">
...
<form action="{{ url('pelanggan_free/create') }}" id="pelanggancreate" method="post" role="form"
            ...
            <div class="row col-lg-12">
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="status_pelanggan" value="Free" class="form-control"
                  disabled="">
                </div>
                <div class="form-group">
