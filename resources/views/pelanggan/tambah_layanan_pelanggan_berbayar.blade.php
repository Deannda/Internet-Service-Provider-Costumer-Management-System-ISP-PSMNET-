    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body">
                       ...
                       <form action="{{ url('tambah_layanan_pelanggan_berbayar/create/'.$nopelanggan) }}" id="tambahlayananpelangganberbayar" method="post" role="form">
                      @csrf
                      <div class="card-body">
                            ...
                            <div class="col-lg-6">
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="status_penagihan_layanan" value="Berbayar" class="form-control"
                                           disabled="">
                              </div>
                              <div class="form-group">
