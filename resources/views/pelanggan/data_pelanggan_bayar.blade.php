        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href ="{{ url('tambah_pelanggan_berbayar')}}" type="button" class="btn btn-primary btn-sm"><i class="fas fa-plus-square"></i>&nbsp;Pelanggan</a>
          
                <div class="card-tools">
                    <form action="{{ url('klasifikasi') }}" method="post">
                        @csrf
                        <input type="hidden" name="status_tagihan" value="Berbayar">
                        <div class="btn-group">
                            <div class="col-lg-12">
                ...
                <table id="example1" class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <center>Riwayat Penagihan</center>
                            </th>
                            <th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $datas->tipepengguna[0]->tipe_pengguna }}</td>
                            <td>{{ $datas->kategoripelanggan[0]->nama_kategori }}</td>
                            <td>{{ $datas->datasektor[0]->nama_sektor }}</td>

                            <td>
                                <center>
                                <a href ="{{ url('data_layanan_pelanggan_berbayar/'.$datas->id_pelanggan) }}" type="button" class="btn btn-primary btn-sm">Layanan</a>
                                <!-- <a href ="#" type="button" class="btn btn-info btn-sm">Tagihan</a> -->
                                </center>

                            </td>
                             <td>
                                <center>
                                <a href ="{{ url('riwayat_tagihan_pelanggan_berbayar') }}" type="button" class="btn btn-success btn-sm">Riwayat</a>
                                <!-- <a href ="#" type="button" class="btn btn-info btn-sm">Tagihan</a> -->
                                </center>
                    ...
                    <div class="modal-content">
                        <div class="modal-header bg-info">
                            <h4 class="modal-title">Info
                                Pelanggan {{ $datas->nama_pelanggan }} </h4>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <p><strong>Alamat Instansi</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $datas->alamat_instansi }}</p>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <p><strong>Kategori Pelanggan</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                &nbsp;&nbsp;: {{$datas->kategoripelanggan[0]->nama_kategori}}</p>
                                                            </div>
                                                            <div class="form-group">
                                                                <p><strong>Sektor</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                    ...
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{$datas->datasektor[0]->nama_sektor}}</p>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <p><strong>Layanan</strong> &nbsp;&nbsp;&nbsp;&nbsp;
                                                                        ...
                                                                        <li>
                                                                            @foreach($listlayanan->layanan as $asd)
                                                                            {{ $asd->nama_layanan }}
                                                                            @endforeach
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <p> Apakah anda yakin ingin menghapus
                    <b>{{ $datas->nama_pelanggan }}</b>? </p>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-outline-light"
                    data-dismiss="modal">Batal
                </button>
                <a href="{{ url('data_pelanggan/delete/'.$datas->id_pelanggan.'/berbayar') }}"
