        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href ="{{ url('tambah_pelanggan_free')}}" type="button" class="btn btn-primary btn-sm"><i class="fas fa-plus-square"></i>&nbsp;Pelanggan</a>
                </button>
                <div class="card-tools">
                    <form action="{{ url('klasifikasi') }}" method="post">
                        @csrf
                        <input type="hidden" name="status_tagihan" value="Free">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href ="{{ url('data_layanan_pelanggan_free/'.$datas->id_pelanggan) }}" type="button" class="btn btn-primary btn-sm">Layanan</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="modal fade" id="edit{{ $datas->id_pelanggan }}">
                                    <div class="modal-dialog modal-xl">
                                        ...
                                        <form
                                        action="{{ url('pelanggan_free/edit/'.$datas->id_pelanggan) }}"
    ...
    <div class="modal fade" id="hapus{{ $datas->id_pelanggan }}">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <a href="{{ url('data_pelanggan/delete/'.$datas->id_pelanggan).'/free' }}"
